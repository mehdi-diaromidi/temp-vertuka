(function ($) {
  ...
  jQuery(document).ready(function ($) {
    $(".md-open-btn").on("click", function () {
      $("#md-overlay").fadeIn(300); // انیمیشن ورود (fade-in)
    });

    // بستن پاپ آپ
    $(".close-btn").on("click", function () {
      $("#md-overlay").fadeOut(300); // انیمیشن خروج (fade-out)
    });
    // Slider
     ...
     */
    $(".full-screen .MJ-pro-vertuka-expand").on("click", function () {
      const src = $(
      ...
      $(".modal-caption-container").slideDown(800).css("opacity", 0).animate(
        {
          opacity: 1,
          marginTop: "0px",
        },
      ...
      modal_img.attr("alt", alt);
      $(".modal-caption").text(alt);
    });
    //MJ separate product from footer
    $(
      ".full-screen #MJ-pro-vertuka-expand, #vertuka-main-product-image > img"
    ).on("click", function () {
      const src = $(
        ".product-page .product-image-gallery .image-box .product-image > img"
      ).attr("src");
    ...
    $(".MJ-pro-vertuka-image-modal .MJ-next-button").on("click", function () {
      ...
      // let vertuka_product_img_alt = $("#MJ-pro-vertuka-image-modal > img").attr(
      //   "alt"
      // );
      ...
      var id = 0;
      if (
        typeof vertuka_product_current_img_id == "undefined" &&
        vertuka_product_current_img_id == null
      ) {
        vertuka_product_current_img_id = "item-1";
      }
      if (
    ...
    if ($("#vertuka-main-product-image .next-button").length > 0) {
      $("#vertuka-main-product-image .next-button").on("click", function () {
        ...
        console.log(vertuka_product_img_src);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const samandehiLogo = document.getElementById("rgvjwlaonbqeoeukrgvjnbqe");

  // Attach a click event listener
  if (samandehiLogo) {
    samandehiLogo.addEventListener("click", function () {
      window.open(
        "https://logo.samandehi.ir/Verify.aspx?id=342832&p=xlaoaodsuiwkmcsixlaouiwk",
        "Popup",
