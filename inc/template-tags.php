...
if (!function_exists('vertuka_main_navbar')) {
	...
	{
		return '<ul class="main-menu"><li><a href="https://vertuka.com/">خانه<i class="icon left-arrow"></i></a></li><li><span href="#">گوشی موبایل<i class="icon left-arrow"></i></span><div class="submenu"><ul class="vertuka-mega-menu"><li><a href="https://vertuka.com/category/mobile/">گوشی موبایل  <span>(همه محصولات)</span><i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/samsung-phone/">گوشی سامسونگ<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/xiaomi-phone/">گوشی شیائومی<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/poco-phone/">گوشی پوکو<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/iphone/">گوشی آیفون<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/nokia-phone/">گوشی نوکیا<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/vocal-phone/">گوشی وکال<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/honor-phone">گوشی آنر<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li></ul></div></li><li><span href="#">تبلت<i class="icon left-arrow"></i></span><div class="submenu"><ul class="vertuka-mega-menu"><li><a href="/category/tablet/">تبلت  <span>(همه محصولات)</span><i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/samsung-tablet/">تبلت سامسونگ<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li></ul></div></li><li><span href="#">ساعت و بند هوشمند<i class="icon left-arrow"></i></span><div class="submenu"><ul class="vertuka-mega-menu"><li><a href="https://vertuka.com/category/watch/">ساعت هوشمند  <span>(همه محصولات)</span><i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/samsung-watch">ساعت هوشمند سامسونگ<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/xiaomi-smartwatch/">ساعت هوشمند شیائومی<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/apple-watch/">ساعت هوشمند اپل<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/smartband/">مچ بند هوشمند<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/haylou-watch/">ساعت هوشمند هایلو<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li></ul></div></li><li><span href="#">هدفون و هندزفری<i class="icon left-arrow"></i></span><div class="submenu"><ul class="vertuka-mega-menu"><li><a href="https://vertuka.com/category/headphone/">هدفون و هندزفری  <span>(همه محصولات)</span><i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/samsung-headphone/">هندزفری سامسونگ<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/qcy-headphones/">هندزفری QCY<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/airpods/">هندزفری اپل (ایرپاد)<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/xiaomi-headphone/">هندزفری شیائومی<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/anker-headphones/">هندزفری انکر<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/riversong-headphone/">هندزفری ریورسانگ<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/huawei-headphone/">هندزفری هوآوی<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li></ul></div></li><li><span href="#">لوازم جانبی<i class="icon left-arrow"></i></span><div class="submenu"><ul class="vertuka-mega-menu"><li><a href="https://vertuka.com/category/accessories/">لوازم جانبی  <span>(همه محصولات)</span><i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="https://vertuka.com/category/charger/">شارژر و آداپتور<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/car-charger/">شارژر فندکی<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/cable/">کابل شارژ<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li><li><a href="/category/powerbank/">پاوربانک<i class="icon left-arrow"></i></a><div class="menu-img-box"><div class="circle"></div></div></li></ul></div></li><li><a href="https://vertuka.com/category/offers" style="color:#1f9a17; font-weight:700;">تخفیکا %</a></li></ul>';
		// MJ test speed
		////////////////////////////////////////////
		...
		?>
			...
			<div class="position-relative">
				...
				<div class="edit-address">
					<!--                    <a class=" wcmca_edit_address_button" data-id="--><?php //echo $address_id; 
																								?><!--" href="#wcmca_address_form_container_shipping" data-type="shipping">-->
...
//add_action('woocommerce_checkout_before_customer_details', 'vertuka_custom_checkout_field_woocommerce');
//
//function vertuka_custom_checkout_field_woocommerce($checkout) {
//    echo '<div id="vertuka_custom_order_field" class="d-none">';
//
//    // Text Field
...
//    ), $checkout->get_value('vertuka_custom_text_field'));
//
//    // Radio Button
...
//            'haghighi' => 'حقیقی',
//        ),
//    ), $checkout->get_value('vertuka_custom_radio_field'));
//
//    echo '</div>';
//}
//
//// Save custom fields as order meta
//add_action('woocommerce_checkout_update_order_meta', 'save_custom_order_fields');
//
//function save_custom_order_fields($order) {
//    // Save custom text field
//    if (!empty($_POST['vertuka_custom_text_field'])) {
//        $order->update_meta_data('_vertuka_custom_text_field', sanitize_text_field($_POST['vertuka_custom_text_field']));
//    }
//
//    // Save custom radio field
//    if (!empty($_POST['vertuka_custom_radio_field'])) {
//        $order->update_meta_data('_vertuka_custom_radio_field', sanitize_text_field($_POST['vertuka_custom_radio_field']));
//    }
//}
...
function save_custom_checkout_field_value($order_id)
{
	...
	if ($_POST['vertuka_custom_radio_field']) {
		...
		// if (sanitize_text_field($_POST['vertuka_custom_radio_field']) == 'hoghooghi') {
		// 	update_post_meta($order_id, 'company', sanitize_text_field(get_user_meta($order_id, 'company', true)));
		// 	update_post_meta($order_id, 'economic_id', sanitize_text_field(get_user_meta($order_id, 'economic_id', true)));
		// 	update_post_meta($order_id, 'company_national_code', sanitize_text_field(get_user_meta($order_id, 'company_national_code', true)));
		// 	update_post_meta($order_id, 'registration_id', sanitize_text_field(get_user_meta($order_id, 'registration_id', true)));
		// 	update_post_meta($order_id, 'company_address', sanitize_text_field(get_user_meta($order_id, 'company_address', true)));
		// }
	}
...
function mj_validate_checkout($posted)
{
	...
	if ($_POST['shipping_first_name'] == '') {
		return wc_add_notice(__("لطفا آدرس و شیوه ارسال را انتخاب کنید.", 'mj_validate_checkout_error'), 'error');
	}
	...
	if ($_POST['vertuka_custom_text_field'] == 'پیک-رایگان') {
		return wc_add_notice(__("لطفا زمان دریافت را انتخاب کنید.", 'mj_validate_checkout_error'), 'error');
	}
	// // baraye yeky shodan input va ravesh ersal
	// 	if ($_POST['shipping_method[0]'] == 'post' && $_POST['vertuka_custom_text_field'] != 'پست') {
	// 		return wc_add_notice(__("لطفا فرم را دوباره پر کنید.", 'mj_validate_checkout_error'), 'error');
	// 	}

	// 	if ($_POST['shipping_method[0]'] == 'aady' && !str_contains($_POST['vertuka_custom_text_field'], 'ساعت')) {
	// 		return wc_add_notice(__("لطفا فرم را دوباره پر کنید.", 'mj_validate_checkout_error'), 'error');
	// 	}

	// 	if ($_POST['shipping_method[0]'] == 'flat_rate:5' && $_POST['vertuka_custom_text_field'] != 'پیک-توربو') {
	// 		return wc_add_notice(__("لطفا فرم را دوباره پر کنید.", 'mj_validate_checkout_error'), 'error');
	// 	}
}
