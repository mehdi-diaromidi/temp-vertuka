                ...
                <div class="d-flex">
                    <div class="img-box me-3">
                            ...
                            if ( ! $product_permalink ) {
                                ...
                                printf( '<a class="d-block w-100" href="%s">%s</a>', esc_url( $product_permalink ), $thumbnail ); // PHPCS: XSS ok.
                            }
                            ?>
                    </div>

                    <div class="p-info pt-1 me-2">
                        <div class="mb-2">
                            <?php
                            if ( ! $product_permalink ) {
                                 ...
                                 * @since 2.1.0
                                 */
                                echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a class="cart-product-title title" href="%s"><p class="title">%s</p></a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key ) );
                            }
                    ...
                    <div class="p-price">
                        <div class="price-box d-flex">
                            <div class="me-3 price">
                                <?php
                                echo vertuka_persian_number( apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ) ); // PHPCS: XSS ok.
                                ?>
                            </div>
                            ...
                            <div class="position-relative">
                                ...
                                echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                    ...
                                    sprintf(
                                        '<a href="%s" class="remove remove-item" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="icon close-2"></i></a>',
